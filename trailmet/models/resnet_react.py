...
class Bottleneck(nn.Module):
    ...
    def __init__(self, inplanes, planes, stride=1, downsample=None,binarize=False):
...
class ResNet(BaseModel):
    def __init__(self, block, layers,num_fp=10, width=1, num_classes=1000, produce_vectors=False, init_weights=True, insize=32):
